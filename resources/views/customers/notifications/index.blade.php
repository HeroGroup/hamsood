...
<div style="margin:70px 0;color:#222;">
    ...
    @foreach($notifications as $notification)
        <div style="border:1px solid gray;border-radius:5px;padding:10px 30px;margin-bottom:10px;">
            ...
            <hr>
            <h4>{{$notification->notification_type === 1 ? "تسویه حساب نهایی انجام شد و مبلغ $notification->notification_text تومان به کیف پول شما برگشت داده شد." : ($notification->notification_type === 2 ? "تسویه حساب نهایی انجام شد و مبلغ $notification->notification_text تومان از صورتحساب شما کسر شد. " : $notification->notification_text)}}</h4>
