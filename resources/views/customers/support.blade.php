    ...
    <div style="background-color:white;border-radius:5px;box-shadow: 0 0 3px #888888;padding:10px 15px;">
        ...
        <div style="display: flex;">
            ...
            <div style="flex:2;padding:5px;">
                <label>میدان قائم ، کوچه 1 شهیدآیت اله ربانی، کوچه 3 آزادی، پلاک 8، ساختمان آپارتمان 8، طبقه همکف</label>
            </div>
        </div>
        <div style="display: flex;">
            <div style="flex:1;">
                <i class="fa fa-phone" style="font-size:22px;color:#64498E;transform:rotateY(180deg);"></i>
                <label style="color:#64498E;">شماره تلفن</label>
            </div>
            <div style="flex:2;padding:5px;">
                <label>09177140366</label>
            </div>
        </div>
    </div>
</div>
